...
function generateUniqueId(){
  ...
  const hexadecimanString =  randowmNumber.toString(16);
...
const handleSubmit = async(e) =>{
 ...
 chatContainer.innerHTML  += chatStripe(true,
  ...
  //fetsh data from server

console.log( '**************' + data.get('prompt'));
    const response = await fetch('https://codex-k9c6.onrender.com',{
    method: 'POST',
    headers : {
  ...
  else
  {
    ...
    messageDiv.innerHTML = "Quelques pas correct se passe!";
    alert(err);
  }
}
